...
export default function App() {
  ...
  return (
    ...
    <div className="container has-image-background">
      ...
      {loading ? <div className="container"><h1>Search For City</h1></div> : (
        <WeatherCard>
        <LeftSide>
          <MainWeather 
        ...
        <RightSide>
          ...
          <HighlightWrapper>
            ...
            <HighlightCard>
              <p>Humidity</p>
              <div><span className="display-3">{weather.list[2].main.humidity}</span>%</div>
            </HighlightCard>

            <HighlightCard>
              <p>Winds Speed</p>
              <div><span className="display-3">{weather.list[2].wind.speed}</span> M/S</div>
            </HighlightCard>

            <HighlightCard>
              <p>Pressure</p>
              <div><span className="display-3">{weather.list[2].main.pressure}</span> hPa</div>
            </HighlightCard>

            <HighlightCard>
              <p>Visibility</p>
              <div><span className="display-3">{(weather.list[2].visibility)/1000}</span> KM</div>
            </HighlightCard>
